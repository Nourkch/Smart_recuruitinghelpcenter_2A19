...
candidats :: candidats (int cin,QString nom,QString prenom ,QString email,QString sexe,QString rue,int codepostal,QDate date_naissance,QString ville)
{
...
candidats :: candidats (int id_candidat, int cin,QString nom,QString prenom ,QString email,QString sexe,QString rue,int codepostal,QDate date_naissance,QString ville)
{
...
int candidats:: getCIN(){return cin;}
QString candidats:: getnom() {return nom;}
    QString candidats:: getprenom(){return prenom;}
    QString candidats::getadressemail(){return email;}
    QString candidats::getrue(){return rue;}
    int candidats::getcodepostal(){return codepostal;}
    QString candidats::getsexe(){ return sexe;}
    QString candidats:: getville(){return ville;}
int candidats:: getID_candidat(){return id_candidat;}
    QDate candidats :: getDatenaissance(){return date_naissance;}


bool candidats::ajouter_candidat()
{
    QSqlQuery query;
    QString i;
...
bool candidats:: supprimer_candidat(int id)
{
    QSqlQuery query;
...
bool candidats::modifier_candidat()
{
    QSqlQuery query;
